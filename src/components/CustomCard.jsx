...
export default function CustomCard() {
  ...
  return (
    <div className="container flex flex-col gap py-2 px-10 max-w-[900px]">
      <Card className="mt-6 bg-white dark:bg-zinc-900 shadow-transparent">
        <Avatar src={moebooka} alt="avatar" size="xl" />
        <CardBody className="p-0 pt-6">
          <Typography variant="h2" color="white" className="mb-2">
            Junior mobile and web developer, independent artist.
          </Typography>
          <Typography className="text-slate-500 dark:text-zinc-500">
